...
/**
 * Se llama test de integración por que en este caso se lanza contra MySQL en lugar de contra H2
 */
...
public class MySQLIntegrationTest {
    ...
    void testBookUuid() {
        ...
        BookUuid fetchedBook = bookUuidRepository.getById(bookUuid.getId());
